...
public class ShopProductController {
	...
	private MetricUtil metrics = new MetricUtil();
	...
	@SuppressWarnings("unchecked")
	public String display0(final String reference, final String friendlyUrl, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
	...
	public static Tracer getTracer() {
		return GlobalOpenTelemetry.getTracer("shop-product", "1.0.0");
	}
